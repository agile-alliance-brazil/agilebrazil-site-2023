...
(function($) {
	window.dataProgram = {
		9: {
			...
			'identificacao-1050-1': `<div class="activity raizes card-program">
			...
			'identificacao-1050-3': `<div class="activity metrica card-program">
			...
			'identificacao-1050-4': `<div class="activity cliente card-program">
			...
			'identificacao-1050-5': `<div class="activity workspace card-program">
			...
			'identificacao-1130-2': `<div class="activity workspace card-program">
					<div class="local-palestra">Palestra 1</div>
					<p class="title">JOGAM-SE CARTAS: poderoso baralho de tendências para trazer sua visão de futuro e traçar um mapa estratégico para sair da inércia em 130 minutos</p>
					<p class="autor">Estefany Medici e Maíra do Vale Machado</p>
				</div>`,
			'identificacao-1130-3': `<div class="activity workspace card-program">
					<div class="local-palestra">Palestra 2</div>
					<p class="title">JOGAM-SE CARTAS: poderoso baralho de tendências para trazer sua visão de futuro e traçar um mapa estratégico para sair da inércia em 130 minutos</p>
					<p class="autor">Estefany Medici e Maíra do Vale Machado</p>
				</div>`,
			'identificacao-1130-4': `<div class="activity workspace card-program">
					<div class="local-palestra">Palestra 3</div>
					<p class="title">JOGAM-SE CARTAS: poderoso baralho de tendências para trazer sua visão de futuro e traçar um mapa estratégico para sair da inércia em 130 minutos</p>
					<p class="autor">Estefany Medici e Maíra do Vale Machado</p>
				</div>`,
			'identificacao-1210-1': `<div class="activity workspace card-program">
					<div class="local-palestra">Auditótio</div>
					<p class="title">JOGAM-SE CARTAS: poderoso baralho de tendências para trazer sua visão de futuro e traçar um mapa estratégico para sair da inércia em 130 minutos</p>
					<p class="autor">Estefany Medici e Maíra do Vale Machado</p>
				</div>`,
			'identificacao-1210-2': `<div class="activity workspace card-program">
					<div class="local-palestra">Palestra 1</div>
					<p class="title">JOGAM-SE CARTAS: poderoso baralho de tendências para trazer sua visão de futuro e traçar um mapa estratégico para sair da inércia em 130 minutos</p>
					<p class="autor">Estefany Medici e Maíra do Vale Machado</p>
				</div>`,
			'identificacao-1210-3': `<div class="activity workspace card-program">
					<div class="local-palestra">Palestra 2</div>
					<p class="title">JOGAM-SE CARTAS: poderoso baralho de tendências para trazer sua visão de futuro e traçar um mapa estratégico para sair da inércia em 130 minutos</p>
					<p class="autor">Estefany Medici e Maíra do Vale Machado</p>
				</div>`,
			'identificacao-1210-4': `<div class="activity workspace card-program">
					<div class="local-palestra">Palestra 3</div>
					<p class="title">JOGAM-SE CARTAS: poderoso baralho de tendências para trazer sua visão de futuro e traçar um mapa estratégico para sair da inércia em 130 minutos</p>
					<p class="autor">Estefany Medici e Maíra do Vale Machado</p>
				</div>`,
			...
			'identificacao-1430-5': `<div class="activity workspace card-program">
					<p class="title">Jogo da Segurança Psicológica: Vamos aprender a avaliar os ambientes?</p>
					<p class="autor">Daniela Gomes dos Santos</p>
				</div>`,
			'identificacao-1430-6': `<div class="activity workspace card-program">
					<p class="title">XP Game - O desafio de tornar seu time de desenvolvimento mais ágil</p>
					<p class="autor">Wagner Fusca Voltz e Pedro Luiz Martins Cruz</p>
				</div>`,
			'identificacao-1430-7': `<div class="activity workspace card-program">
					<p class="title">JOGAM-SE CARTAS: poderoso baralho de tendências para trazer sua visão de futuro e traçar um mapa estratégico para sair da inércia em 130 minutos</p>
					<p class="autor">Estefany Medici e Maíra do Vale Machado</p>
				</div>`,
			...
			'identificacao-1510-3': `<div class="activity metrica card-program">
					<div class="local-palestra">Palestra2</div>
					<p class="title">Como Migrar de Gerenciamento de Projetos Tradicionais para Fluxos de Valor</p> 
					<p class="autor">Mônica Fonseca</p>
				</div>`,
